...
# http://www.en.sysadmin-cookbook.net/openldap/

# error codes:
# https://support.microsoft.com/en-us/help/218185/microsoft-ldap-error-codes

# result codes of ldap:
...
# Adding user into ldap
# ldapadd -x -W -D "cn=admin,dc=ldaplocal,dc=com" -f add_content.ldif

# it will prompt for the password is "admin"
